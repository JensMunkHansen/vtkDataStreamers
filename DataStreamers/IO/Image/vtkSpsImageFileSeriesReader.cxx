/*=========================================================================
  ...
  Program:   ParaView
  Module:    vtkSpsImageFileSeriesReader.cxx
...
vtkStandardNewMacro(vtkSpsImageFileSeriesReader)
//----------------------------------------------------------------------------
vtkSpsImageFileSeriesReader::vtkSpsImageFileSeriesReader()
{
  this->ReadAsImageStack = false;
}

//----------------------------------------------------------------------------
vtkSpsImageFileSeriesReader::~vtkSpsImageFileSeriesReader() = default;

//----------------------------------------------------------------------------
int vtkSpsImageFileSeriesReader::ProcessRequest(
...
//----------------------------------------------------------------------------
void vtkSpsImageFileSeriesReader::UpdateReaderDataExtent()
{
...
//----------------------------------------------------------------------------
void vtkSpsImageFileSeriesReader::UpdateFileNames()
{
  vtkImageReader2* imageReader = vtkImageReader2::SafeDownCast(this->Reader);
  if (!imageReader)
  {
...
//----------------------------------------------------------------------------
void vtkSpsImageFileSeriesReader::PrintSelf(ostream& os, vtkIndent indent)
{
