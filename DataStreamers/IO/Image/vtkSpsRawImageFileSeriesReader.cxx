...
=========================================================================*/
#include "vtkSpsRawImageFileSeriesReader.h"

#include "vtkImageReader2.h"
#include "vtkObjectFactory.h"

vtkStandardNewMacro(vtkSpsRawImageFileSeriesReader);
//----------------------------------------------------------------------------
vtkSpsRawImageFileSeriesReader::vtkSpsRawImageFileSeriesReader()
...
//----------------------------------------------------------------------------
vtkSpsRawImageFileSeriesReader::~vtkSpsRawImageFileSeriesReader() = default;

//----------------------------------------------------------------------------
void vtkSpsRawImageFileSeriesReader::UpdateReaderDataExtent()
{
...
//----------------------------------------------------------------------------
void vtkSpsRawImageFileSeriesReader::PrintSelf(ostream& os, vtkIndent indent)
{
