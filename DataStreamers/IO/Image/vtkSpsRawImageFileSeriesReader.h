...
class VTKSPSIOIMAGE_EXPORT vtkSpsRawImageFileSeriesReader : public vtkSpsImageFileSeriesReader
{
public:
  static vtkSpsRawImageFileSeriesReader* New();
  vtkTypeMacro(vtkSpsRawImageFileSeriesReader, vtkSpsImageFileSeriesReader)
...
private:
  vtkSpsRawImageFileSeriesReader(const vtkSpsRawImageFileSeriesReader&) = delete;
  void operator=(const vtkSpsRawImageFileSeriesReader&) = delete;
};
