...
#include "vtkSpsIOImageModule.h" //needed for exports

class VTKSPSIOIMAGE_EXPORT vtkSpsImageFileSeriesReader : public vtkSpsFileSeriesReader
{
public:
  static vtkSpsImageFileSeriesReader* New();
  vtkTypeMacro(vtkSpsImageFileSeriesReader, vtkSpsFileSeriesReader)
...
protected:
  ...
  ~vtkSpsImageFileSeriesReader() override;
...
private:
  vtkSpsImageFileSeriesReader(const vtkSpsImageFileSeriesReader&) = delete;
  void operator=(const vtkSpsImageFileSeriesReader&) = delete;
};
