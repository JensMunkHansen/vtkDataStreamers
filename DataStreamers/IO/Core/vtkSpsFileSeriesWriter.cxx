/*=========================================================================
  ...
  Program:   ParaView
  Module:    vtkSpsFileSeriesWriter.cxx
...
=========================================================================*/
#include "vtkSpsFileSeriesWriter.h"
...
vtkStandardNewMacro(vtkSpsFileSeriesWriter)
vtkCxxSetObjectMacro(vtkSpsFileSeriesWriter, Writer, vtkAlgorithm)

//-----------------------------------------------------------------------------
vtkSpsFileSeriesWriter::vtkSpsFileSeriesWriter()
{
...
//----------------------------------------------------------------------------
int vtkSpsFileSeriesWriter::Write()
{
...
//----------------------------------------------------------------------------
int vtkSpsFileSeriesWriter::ProcessRequest(
...
//----------------------------------------------------------------------------
int vtkSpsFileSeriesWriter::RequestInformation(vtkInformation* vtkNotUsed(request),
...
//----------------------------------------------------------------------------
int vtkSpsFileSeriesWriter::RequestUpdateExtent(vtkInformation* vtkNotUsed(request),
    vtkInformationVector** inputVector, vtkInformationVector* vtkNotUsed(outputVector))
{
...
//----------------------------------------------------------------------------
int vtkSpsFileSeriesWriter::RequestData(vtkInformation* request, vtkInformationVector** inputVector,
...
//----------------------------------------------------------------------------
bool vtkSpsFileSeriesWriter::WriteATimestep(vtkDataObject* input, vtkInformation* inInfo)
{
  ...
  if (this->WriteAllTimeSteps && this->NumberOfTimeSteps > 1)
  {
    ...
    if (this->FileNameSuffix && vtkSpsFileSeriesWriter::SuffixValidation(this->FileNameSuffix))
    {
  ...
  {
    // TODO: Verify that we dont need to copy DATA_TIME_STEP information
...
vtkMTimeType vtkSpsFileSeriesWriter::GetMTime()
{
  return this->Superclass::GetMTime();
}

//-----------------------------------------------------------------------------
void vtkSpsFileSeriesWriter::WriteInternal()
{
...
#endif
    vtkImageWriter* pWriter = vtkImageWriter::SafeDownCast(this->Writer);
    if (pWriter) {
      pWriter->Write();
    }
  }
...
//-----------------------------------------------------------------------------
void vtkSpsFileSeriesWriter::SetWriterFileName(const char* fname)
{
...
//-----------------------------------------------------------------------------
bool vtkSpsFileSeriesWriter::SuffixValidation(char* fileNameSuffix)
{
...
//-----------------------------------------------------------------------------
void vtkSpsFileSeriesWriter::PrintSelf(ostream& os, vtkIndent indent)
{
