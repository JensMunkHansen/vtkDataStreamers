/*=========================================================================
  ...
  Program:   ParaView
  Module:    vtkSpsFileSeriesWriter.h
...
=========================================================================*/
/**
 * @class   vtkSpsFileSeriesWriter
 * @brief   meta-writer for writing a file series using writers
 * that are not time-aware.
 *
 * vtkSpsFileSeriesWriter is a meta-writer that enables writing a file series using
...
class VTKSPSIOCORE_EXPORT vtkSpsFileSeriesWriter : public vtkDataObjectAlgorithm
{
public:
  static vtkSpsFileSeriesWriter* New();
  vtkTypeMacro(vtkSpsFileSeriesWriter, vtkDataObjectAlgorithm)
...
protected:
  ...
  ~vtkSpsFileSeriesWriter() override;
...
private:
  vtkSpsFileSeriesWriter(const vtkSpsFileSeriesWriter&) = delete;
  void operator=(const vtkSpsFileSeriesWriter&) = delete;
